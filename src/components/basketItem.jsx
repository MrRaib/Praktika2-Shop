    ...
    return (
        <ul className="collection">
            <li className="collection-item">
                {displayName} <i className="material-icons basket-quantity red-text text-lighten-2" onClick={() => decQuantity(mainId)}>remove</i> x {quantity}<i className="material-icons basket-quantity red-text text-lighten-2" onClick={() => incQuantity(mainId)}>add</i> = {price * quantity} $
